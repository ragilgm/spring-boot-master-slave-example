package com.masterslave.springbootmasterslaveexample.repository;
 ...
 **/
@Repository
public class UserRepositories implements UserRepository, UserReadOnlyRepository {

    private UserReadOnlyRepository userReadOnlyRepository;
    private UserRepository userRepository;

    @Autowired
    public UserRepositories(UserReadOnlyRepository userReadOnlyRepository, UserRepository userRepository) {
